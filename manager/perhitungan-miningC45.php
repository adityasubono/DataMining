...
//#3# Jika atribut = total, maka hitung jumlah kasus total, jumlah kasus layak dan jumlah kasus tdk layak
            ...
            $sqlJumlahKasusLayak = mysql_query("SELECT COUNT(*) as jumlah_layak FROM data_survey WHERE status = 'ya' AND status is not null $kondisiAtribut");
            ...
            $sqlJumlahKasusTidakLayak = mysql_query("SELECT COUNT(*) as jumlah_tidak_layak FROM data_survey WHERE status = 'tidak' AND status is not null $kondisiAtribut");
...
//#5# Jika atribut != total (atribut lainnya), maka hitung jumlah kasus total, jumlah kasus layak dan jumlah kasus tdk layak masing2 atribut
            ...
            while($rowNilaiAtribut = mysql_fetch_array($sqlNilaiAtribut)) {
                ...
                // hitung jumlah kasus layak
                $sqlJumlahKasusLayakAtribut = mysql_query("SELECT COUNT(*) as jumlah_layak FROM data_survey WHERE $kondisi AND status = 'ya'");
                ...
                // hitung jumlah kasus TDK layak
                $sqlJumlahKasusTidakLayakAtribut = mysql_query("SELECT COUNT(*) as jumlah_tidak_layak FROM data_survey WHERE $kondisi AND status = 'tidak'");
